...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/amarcoo/markofile/master/GetVersion.txt' ) or 0
...
elseif Text== "سونيك" or Text== "سوني" then return  sendMsg(msg.chat_id_,msg.id_,"[مطور سورس ماركو↯](https://t.me/XXUUU)")
elseif Text== "مصنع بوتات"  then return sendMsg(msg.chat_id_,msg.id_,"[اصنع بوتك الخاص من هنا↯](https://t.me/San3bot)")
elseif Text== "سونيك"  then return sendMsg(msg.chat_id_,msg.id_,"[مالك السورس ](https://t.me/UU_IV)")
