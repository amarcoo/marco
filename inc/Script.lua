...
return '• **  عدد جهاتك المضافة‏‏ ⇜ ❪ '..(redis:get(mark..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n.'
end
...
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[• اهلا انا بوت]]..redis:get(mark..':NameBot:')..[[ .
...
return'• ** شـرط التفعيل البوت اذا كانت المجموعه‏‏ اكثر مـن *【'..redis:get(mark..':addnumberusers')..'】* عضـو .\n' 
end 
end

if MsgText[1] == 'المجموعات' or MsgText[1] == "المجموعات 🌋" then
if not msg.SudoUser then return "• **هذا الامر يخص {المطور} فقط  \n" end
return '• ** عدد المجموعات المفعلة » `'..redis:scard(mark..'group:ids')..'`  ➼' 
end

if MsgText[1] == "المشتركين" or MsgText[1] == "المشتركين Ⓜ" then
if not msg.SudoUser then return "• **هذا الامر يخص {المطور} فقط  \n" end
return '• **عدد المشتركين في البوت : `'..redis:scard(mark..'users')..'` \n'
end
...
return redis:get(mark..":TEXT_SUDO") or '• لا توجد كليشه المطور .\n• يمكنك اضافه كليشه من خلال الامر\n       " `ضع كليشه المطور` " \n'
end
...
if not msg.SudoBase then return "*│*هذا الامر يخص {المطور الاساسي} فقط  \n" end
local GetVerison = https.request( 'https://raw.githubusercontent.com/amarcoo/marcofile/master/GetVersion.txt' ) or 0
...
return '• اصدار سورس مارك : *v'..version..'* \n'
end
...
sendMsg(msg.chat_id_,msg.id_,'• ** عذراً اسم الملف غير مدعوم للنظام او لا يتوافق مع سورس مارك يرجاء جلب الملف الاصلي الذي قمت بسحبه وبدون تعديل ع الاسم\n')
end  
else
...
send_key(msg.sender_user_id_,'   [قناة سورس : مارك](https://t.me/F888w)' ,nil,inline,msg.id_)
return false
end

if (MsgText[1]== "الاحصائيات 💥" or MsgText[1]=="الاحصائيات") then
if not msg.SudoBase then return"• **هذا الامر يخص {المطور الاساسي} فقط  \n" end
return '• الاحصائيات . \n\n• **عدد المجموعات المفعله : '..redis:scard(mark..'group:ids')..'\n• **عدد المشتركين في البوت : '..redis:scard(mark..'users')..'\n'
end
---------------[End Function data] -----------------------
...
return '• **عدد سحكاتك ⇜ ❪ '..(redis:get(mark..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n'
end
...
text = [[• أهلاً انا بوت   []]..redis:get(mark..':NameBot:')..[[] 
...
sendPhoto(msg.chat_id_,msg.id_,redis:get(mark..':WELCOME_BOT'),[[•أهلاً انا بوت ]]..redis:get(mark..':NameBot:')..[[
...
GetUserID(msg.sender_user_id_,function(arg,data)  
welcome = (redis:get(mark..'welcome:msg'..msg.chat_id_) or "• اهلاً عزيزي {الاسم}\n• معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n• اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(mark..'rulse:msg'..msg.chat_id_) or "• مرحباً عزيري القوانين كلاتي .\n• ممنوع نشر الروابط\n• ممنوع التكلم او نشر صور اباحيه\n• ممنوع  اعاده توجيه\n• ممنوع التكلم بالسياسة\n• الرجاء احترام المدراء والادمنيه .\n")
...
welcome = (redis:get(mark..'welcome:msg'..msg.chat_id_) or "• اهلن بك عزيزي {الاسم}\n• معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n• اسم القروب » {المجموعه}")
if welcome then
rules = (redis:get(mark..'rulse:msg'..msg.chat_id_) or "• مرحباً عزيري القوانين كلاتي .\n• ممنوع نشر الروابط\n• ممنوع التكلم او نشر صور اباحيه\n• ممنوع  اعاده توجيه\n• ممنوع التكلم بالسياسة\n• الرجاء احترام المدراء والادمنيه\n")
welcome = welcome:gsub("{القوانين}", rules)
...
SendMention(msg.chat_id_,datau.id_,msg.id_,"• العضو » "..USERNAME.."\n• قمـت بتكرار اكثر مـن "..NUM_MSG_mark.." رسالة‌‏ , لذا تم تقييدك مـن المجموعه‌\n",12,USERCAR) 
return false
end)
end 
...
return sendMsg(msg.chat_id_,msg.id_,"[انت المطور الغالي ♕](https://t.me/F888w) ")
...
if not redis:get('kar') then
  ...
  sendMsg(SUDO_ID,0,'• انتهى الاشتراك في احد المجموعات .\n• المجموعه : '..FlterName(redis:get(mark..'group:name'..msg.chat_id_))..'.\n• ايدي : '..msg.chat_id_)
...
if MsgText[1]== 'جهاتي' then
return '🧟‍♂*│*  عدد جهہآتگ آلمـضـآفهہ‏‏ ⇜ ❪ '..(redis:get(mark..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
local Photo_Weloame = redis:get(mark..':WELCOME_BOT')
if Photo_Weloame then
sendPhoto(msg.chat_id_,msg.id_,Photo_Weloame,[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(mark..':NameBot:')..[[ ✓
...
if MsgText[1] == "شرط التفعيل" then 
return'🚸*│* شـرط آلتفعيل آلبوت آذآ گآنت آلمـجمـوعهہ‏‏ آگثر مـن *【'..redis:get(mark..':addnumberusers')..'】* عضـو  🍁\n' 
end 
end
...
if MsgText[1]== "قناة السورس 📡" and msg.type == "pv" then
local inline = {{{text="⚜│قنآهہ‏‏ آلسـورس ضـغـط هـنـآ ",url="t.me/@F888w"}}}
send_key(msg.sender_user_id_,'  [⚜│  : سورس عماركو](t.me/@F888w)',nil,inline,msg.id_)
return false
end
...
if MsgText[1]== "سحكاتي" then
return '🚸*│*عدد سحہكآتگ ⇜ ❪ '..(redis:get(mark..':edited:'..msg.chat_id_..':'..msg.sender_user_id_) or 0)..' ❫ \n🐾'
end
...
redis:sadd(mark..'users',msg.sender_user_id_)
if redis:get(mark..'lock_service') then 
text = [[🤖╿آهلا انآ بــــوت آســمـي   []]..redis:get(mark..':NameBot:')..[[] 🗽
...
if msg.content_.ID == "MessageChatAddMembers" then  
redis:set(mark.."Who:Added:Me"..msg.chat_id_..':'..msg.content_.members_[0].id_,msg.sender_user_id_)
local mem_id = msg.content_.members_  
local Bots = redis:get(mark.."lock:Bot:kick"..msg.chat_id_) 
for i=0,#mem_id do  
if msg.content_.members_[i].type_.ID == "UserTypeBot" and not Mod(msg) and Bots == "kick" then   
https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..msg.sender_user_id_)
BESSO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
...
if not redis:get(mark..'Added:Me'..msg.chat_id_) then
tdcli_function ({ID = "GetChatMember",chat_id_ = msg.chat_id_,user_id_ = msg.sender_user_id_},function(arg,da) 
if da and da.status_.ID == "ChatMemberStatusCreator" then
send(msg.chat_id_, msg.id_,'⚠¦ انت منشئ المجموعه ') 
return false
end
local Added_Me = redis:get(mark.."Who:Added:Me"..msg.chat_id_..':'..msg.sender_user_id_)
if Added_Me then 
...
if redis:get(mark..'Added:Me'..msg.chat_id_) then
sendMsg(msg.chat_id_,msg.id_,"🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم  تفعيل امر منو ضافني\n✓")
redis:del(mark..'Added:Me'..msg.chat_id_)  
else
...
if not redis:get(mark..'Added:Me'..msg.chat_id_) then
redis:set(mark..'Added:Me'..msg.chat_id_,true)  
sendMsg(msg.chat_id_,msg.id_,"🙋🏼‍♂️*¦* أهلا عزيزي "..msg.TheRankCmd.."\n📡*¦* تم  تعطيل منو ضافني\n✓")
else
...
if msg.adduser and msg.adduser == our_id and redis:get(mark..':WELCOME_BOT') then
sendPhoto(msg.chat_id_,msg.id_,redis:get(mark..':WELCOME_BOT'),[[⚜╿اهلا انآ بوت آسـمـي ]]..redis:get(mark..':NameBot:')..[[ ✓
👨🏻‍✈️│آختصـآصـي حمـآيهہ‌‏ آلمـجمـوعآت
📛╽مـن آلسـبآم وآلتوجيهہ‌‏ وآلتگرآر وآلخ...
...
welcome = (redis:get(mark..'welcome:msg'..msg.chat_id_) or "🙋🏻‍♂│اهلن بك عزيزي {الاسم}\n🎟│معرفك » {المعرف}\n{القوانين}\n\nالرجاء الالتزام بالقوانين ♥\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n⚜│اسم الكروب » {المجموعه}")
if welcome then
rules = (redis:get(mark..'rulse:msg'..msg.chat_id_) or "👨🏻‍💻╿مرحبأ عزيري القوانين كلاتي 👇🏻\n♦️│ممنوع نشر الروابط\n⚠️│ممنوع التكلم او نشر صور اباحيه\n⚔│ممنوع  اعاده توجيه\n💭│ممنوع التكلم بلطائفه\n♥️╽الرجاء احترام المدراء والادمنيه 😅\n")
welcome = welcome:gsub("{القوانين}", rules)
if data.username_ then UserName = '@'..data.username_ else UserName = '< لا يوجد معرف >' end
welcome = welcome:gsub("{المجموعه}",Flter_Markdown((redis:get(mark..'group:name'..msg.chat_id_) or '')))
local welcome = welcome:gsub("{المعرف}",UserName)
...
if datau.username_ then USERNAME = '@'..datau.username_ else USERNAME = FlterName(datau.first_name_..' '..(datau.last_name_ or "")) end
local USERCAR = utf8.len(USERNAME)
SendMention(msg.chat_id_,datau.id_,msg.id_,"🙍🏻‍♂╿العضو » "..USERNAME.."\n🚸╽قمـت بتگرآر آگثر مـن "..NUM_MSG_mark.." رسـآلهہ‌‏ , لذآ تم تقييدگ مـن آلمـجمـوعهہ‌‏ ✓\n",12,USERCAR) 
return false
end)
end 
redis:setex(mark..'user:'..msg.sender_user_id_..':msgs',2,msgs+1)
...
elseif Text== "عماركو" then return sendMsg(msg.chat_id_,msg.id_,"[مالـك السورس 😍](t.me/XXUUU")
elseif Text== "عمار" then return sendMsg(msg.chat_id_,msg.id_,"[  مطور سورس عماركو 😍](t.me/XXUUU")
...
👨🏽‍⚖️│بالتـوفيـق عزيزي ...
🎁╽[اضغط هنا لديك مفاجئه](https://t.me/F888w)
]] )
--=====================================
