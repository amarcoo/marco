--[[
  ...
  ███    ███ ███          ██               ██             ██                   ██
▄█████████▀           ██               ██             ██                    ██▄████████▀ │𝐁𝐈𝐓𝐀 ﹏ @UU_IV
│تم تطوير وبرمجة السورس من قبل سونيككᐂ .
│@UU_IV
#-------------------------------------------------------------------
]]
...
----------------------{ Get Name Bot }-----------------------------
Bot_Name = redis:get(marco..":NameBot:")
...
var =  'مطور السورس'
elseif redis:sismember(marco..':SUDO_BOT:',UserID) then
var = 'مطور البوت ' 
elseif redis:sismember(marco..':KARA_BOT:'..ChatID,UserID) then
var = ' المنشىء الاساسي' 
elseif redis:sismember(marco..':MONSHA_BOT:'..ChatID,UserID) then
var = ' المنشىء ' 
elseif redis:sismember(marco..'owners:'..ChatID,UserID) then
var = 'مدير البوت ' 
elseif redis:sismember(marco..'admins:'..ChatID,UserID) then
var = 'ادمن في البوت ' 
elseif redis:sismember(marco..'whitelist:'..ChatID,UserID) then
var = 'عضو مميز ' 
else
var = 'فقط عضو ' 
end
...
if msg.edited then
redis:incr(marco..':edited:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.text and not msg.forward_info then
redis:incr(marco..'msgs:'..msg.sender_user_id_..':'..msg.chat_id_)
elseif msg.adduser then 
redis:incr(marco..':adduser:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.photo then
redis:incr(marco..':photo:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.sticker then
redis:incr(marco..':sticker:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.voice then
redis:incr(marco..':voice:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.audio then
redis:incr(marco..':audio:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.video or msg.video_note then
redis:incr(marco..':video:'..msg.chat_id_..':'..msg.sender_user_id_)
elseif msg.animation then
redis:incr(marco..':animation:'..msg.chat_id_..':'..msg.sender_user_id_)
end
end
...
local list = redis:smembers(marco..':SUDO_BOT:')
message = '-  قائمه الـمـطـوريـن : \n\n`- مطور اساسي`**\n'..SUDO_USER..' ⇦ ❪' ..SUDO_ID.. '❫\n*———————— *\n'
if #list==0 then  message = message.."* - لا يوجد مطورين حاليا \n✶*"
else
for k,v in pairs(list) do
local info = redis:hgetall(marco..'username:'..v)
local count = redis:scard(marco..'mtwr_count'..v)
...
local monsha = redis:smembers(marco..':MONSHA_BOT:'..msg.chat_id_)
if #monsha == 0 then 
...
message = message..'*————————  \n\n📋│ قائمه المدراء :*\n\n'
local list = redis:smembers(marco..'owners:'..msg.chat_id_)
if #list == 0 then  
...
local list = redis:smembers(marco..'admins:'..msg.chat_id_)
...
local list = redis:smembers(marco..'whitelist:'..msg.chat_id_)
...
if redis:sismember(marco..'is_silent_users:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(marco..'is_silent_users:'..msg.chat_id_)
...
if redis:sismember(marco..'banned:'..Group,User) then 
return true 
else
return false
end 
...
local list = redis:smembers(marco..'banned:'..msg.chat_id_)
...
if redis:sismember(marco..'gban_users',User) then 
return true 
else
return false
end 
...
local list = redis:smembers(marco..'gban_users')
...
local list = redis:smembers(marco..':Filter_Word:'..msg.chat_id_)
if #list ~=0 then
...
if redis:sismember(marco..':Filter_Word:'..msg.chat_id_,word) then 
return  "- **الكلمه *{"..word.."}* هي بالتأكيد من قائمه المنع✓️" 
else
redis:sadd(marco..':Filter_Word:'..msg.chat_id_,word) 
...
if redis:sismember(marco..':Filter_Word:'..msg.chat_id_,word) then 
redis:srem(marco..':Filter_Word:'..msg.chat_id_,word) 
...
EnterCmd = true
local NumberFlood = tonumber(redis:get(marco..':Flood_Spam:'..msg.sender_user_id_..':msgs') or 0)
if NumberFlood > 3 then 
redis:setex(marco..':Flood_Spam:'..msg.sender_user_id_..':Stoped',10,true)
EnterCmd = false
elseif redis:get(marco..':Flood_Spam:'..msg.sender_user_id_..':Stoped') then
EnterCmd = false
else
redis:setex(marco..':Flood_Spam:'..msg.sender_user_id_..':msgs',3,NumberFlood+1)
end
return EnterCmd
end
...
json_data = '{"BotID": '..marco..',"UserBot": "'..Bot_User..'","Groups" : {'
local All_Groups_ID = redis:smembers(marco..'group:ids')
for key,GroupS in pairs(All_Groups_ID) do
local NameGroup = (redis:get(marco..'group:name'..GroupS) or '')
...
local admins = redis:smembers(marco..'admins:'..GroupS)
if #admins ~= 0 then
json_data =  json_data..',"Admins" : {'
for key,value in pairs(admins) do
local info = redis:hgetall(marco..'username:'..value)
if info then 
...
local creators = redis:smembers(marco..':MONSHA_BOT:'..GroupS)
if #creators ~= 0 then
...
local creator = redis:smembers(marco..':KARA_BOT:'..GroupS)
if #creator ~= 0 then
...
local owner = redis:smembers(marco..'owners:'..GroupS)
if #owner ~= 0 then
...
local list = redis:smembers(marco..'group:ids')
message = '- **قائمه المجموعات :\n\n'
for k,v in pairs(list) do 
local info = redis:get(marco..'group:name'..v)
if info then 
...
redis:del(
marco..'group:add'..id_group,
marco..'lock_link'..id_group, 
marco..'lock_id'..id_group,
marco..'lock_spam'..id_group, 
marco..'lock_webpage'..id_group,
marco..'lock_markdown'..id_group,
marco..'lock_flood'..id_group,
marco..'lock_bots'..id_group,
marco..'mute_forward'..id_group,
marco..'mute_contact'..id_group,
marco..'mute_location'..id_group,
marco..'mute_document'..id_group,
marco..'mute_keyboard'..id_group,
marco..'mute_game'..id_group,
marco..'mute_inline'..id_group,
marco..'lock_username'..id_group,
marco..'num_msg_marco'..id_group,
marco..'replay'..id_group
)
redis:srem(marco..'group:ids',id_group)
end
...
redis:hset(marco..'username:'..data.id_,'username',ResolveUser(data))
redis:sadd(marco..'admins:'..msg.chat_id_,data.id_)
end,nil)
end
end
if NumAdmin == 0 then 
...
function modadd(msg)
if redis:get(marco..'lock_service') then
service = true
Get_Director = 30
else
service = false
...
if redis:get(marco..'group:add'..msg.chat_id_) then  return '•**المجموعه بالتأكيد تم تفعيلها' end

local UserChaneel = redis:get(marco..":UserNameChaneel")
...
redis:setex(marco..":ismember:"..msg.sender_user_id_,1500,true)
GetFullChat(msg.chat_id_,function(arg,data) 
local GroupUsers = tonumber(redis:get(marco..':addnumberusers') or 0)
...
local lock_service = redis:get(marco..'lock_service')
...
GetUserID(v.user_id_,function(arg,data)
redis:hset(marco..'username:'..data.id_, 'username', ResolveUser(data))
redis:sadd(marco..':KARA_BOT:'..msg.chat_id_,data.id_)
end)
...
redis:mset(
marco..'group:add'..msg.chat_id_,true,
marco..'lock_link'..msg.chat_id_,true, 
marco..'lock_id'..msg.chat_id_,true,
marco..'lock_spam'..msg.chat_id_,true,
marco..'lock_webpage'..msg.chat_id_,true,
marco..'lock_markdown'..msg.chat_id_,true,
marco..'lock_flood'..msg.chat_id_,true,
marco..'lock_bots'..msg.chat_id_,true,
marco..'mute_forward'..msg.chat_id_,true,
marco..'mute_contact'..msg.chat_id_,true,
marco..'mute_location'..msg.chat_id_,true,
marco..'mute_document'..msg.chat_id_,true,
marco..'mute_keyboard'..msg.chat_id_,true,
marco..'mute_game'..msg.chat_id_,true,
marco..'mute_inline'..msg.chat_id_,true,
marco..'lock_username'..msg.chat_id_,true,
marco..'num_msg_marco'..msg.chat_id_,5, 
marco..'replay'..msg.chat_id_,true
)

redis:sadd(marco..'group:ids',msg.chat_id_) 
redis:sadd(marco..'mtwr_count'..msg.sender_user_id_,msg.chat_id_)

GroupTitle(msg.chat_id_,function(arg,data)
local NameGroup = data.title_
redis:set(marco..'group:name'..msg.chat_id_,NameGroup)
...
redis:set(marco..'linkGroup'..msg.chat_id_,Gp_Link)
...
if not redis:get(marco..'group:add'..msg.chat_id_) then return '- ** المجموعه بالتأكيد تم تعطيلها' end  
...
if redis:sismember(marco..':MONSHA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء  \n✓️',17,USERCAR) 
end
redis:hset(marco..'username:'..UserID,'username',Resolv)
redis:sadd(marco..':MONSHA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء في البوت \n✓️',17,USERCAR) 
end

if cmd == "remmnsha" then
if not redis:sismember(marco..':MONSHA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء \n✓️',17,USERCAR) 
end
redis:srem(marco..':MONSHA_BOT:'..ChatID,UserID)
...
if redis:sismember(marco..':KARA_BOT:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد منشىء اساسي \n✓️',17,USERCAR) 
end
redis:hset(marco..'username:'..UserID,'username',Resolv)
redis:sadd(marco..':KARA_BOT:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح منشىء اساسي في البوت \n✓️',17,USERCAR) 
end

if cmd == "remkara" then
if not redis:sismember(marco..':KARA_BOT:'..ChatID,UserID) then
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس منشىء اساسي\n✓️',17,USERCAR) 
end
redis:srem(marco..':KARA_BOT:'..ChatID,UserID)
...
if redis:sismember(marco..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد عضو مميز \n✓️',17,USERCAR) 
end
redis:hset(marco..'username:'..UserID, 'username', Resolv)
redis:sadd(marco..'whitelist:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح عضو مميز \n✓️',17,USERCAR) 
end

if cmd == "remwhitelist" then
if not redis:sismember(marco..'whitelist:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس عضو مميز \n✓️',17,USERCAR) 
end
redis:srem(marco..'whitelist:'..ChatID,UserID)
...
if redis:sismember(marco..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد مدير \n✓️',17,USERCAR) 
end
redis:hset(marco..'username:'..UserID, 'username', Resolv)
redis:sadd(marco..'owners:'..ChatID,UserID)
...
if redis:sismember(marco..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد ادمن \n✓️',17,USERCAR) 
end
redis:hset(marco..'username:'..UserID, 'username', Resolv)
redis:sadd(marco..'admins:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تمت ترقيته ليصبح ادمن \n✓️',17,USERCAR) 
end

if cmd == "remowner" then
if not redis:sismember(marco..'owners:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مدير \n✓️',17,USERCAR) 
end
redis:srem(marco..'owners:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم تنزيله من المدير  \n✓️',17,USERCAR) 
end

if cmd == "demote" then
if not redis:sismember(marco..'admins:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس ادمن \n✓️',17,USERCAR) 
end
redis:srem(marco..'admins:'..ChatID,UserID)
...
if cmd == "active" then
local maseegs = redis:get(marco..'msgs:'..UserID..':'..ChatID) or 1
...
redis:hset(marco..'username:'..UserID, 'username', Resolv)
redis:sadd(marco..'banned:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم حظره  \n✓️',17,USERCAR) 
end
end)
...
if cmd == "unban" then
if not redis:sismember(marco..'banned:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم بالتأكيد الغاء حظره  \n✓️',17,USERCAR) 
else
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم الغاء حظره \n✓️',17,USERCAR) 
end
redis:srem(marco..'banned:'..ChatID,UserID)
...
if redis:sismember(marco..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم بالتأكيد كتمه  \n✓️',17,USERCAR) 
end
redis:hset(marco..'username:'..UserID, 'username', Resolv)
redis:sadd(marco..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم كتمه \n✓️',17,USERCAR) 
end

if cmd == "unsilent" then
if not redis:sismember(marco..'is_silent_users:'..ChatID,UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم بالتاكيد الغاء كتمه  \n✓️',17,USERCAR) 
end
redis:srem(marco..'is_silent_users:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم الغاء كتمه  \n✓️',17,USERCAR) 
end
...
redis:hset(marco..'username:'..UserID, 'username',Resolv)
redis:sadd(marco..'gban_users',UserID)
...
redis:srem(marco..'gban_users',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم الغاء حظره العام \n✓️',17,USERCAR) 
end
...
if redis:sismember(marco..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد مطور \n✓️',17,USERCAR) 
end
redis:hset(marco..'username:'..UserID, 'username', Resolv)
redis:sadd(marco..':SUDO_BOT:',UserID)
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم ترقيته ليصبح مطور \n✓️',17,USERCAR) 
end

if cmd == "dn_sudo" then
if not redis:sismember(marco..':SUDO_BOT:',UserID) then 
return SendMention(ChatID,UserID,MsgID,'- العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- انه بالتأكيد ليس مطور \n✓️',17,USERCAR) 
end
redis:srem(marco..':SUDO_BOT:',UserID)
...
redis:hset(marco..'username:'..UserID, 'username', UserName)
redis:sadd(marco..':MONSHA_BOT:'..ChatID,UserID)
return sendMsg(ChatID,MsgID,'- **العضو ⇦ ❪ '..UserName..' ❫\n- **الايدي ⇦ ❪ `'..UserID..'` ❫\n- **تمت ترقيته ليصبح منشىء في البوت \n✓️')
end
...
if redis:sismember(marco..'banned:'..ChatID,UserID) then 
return sendMsg(ChatID,MsgID,'- **العضو ⇦ ❪ '..UserName..' ❫\n- **الايدي ⇦ ❪ `'..UserID..'` ❫\n- **تم بالتأكيد حظره \n✓️') 
end
kick_user(UserID, ChatID,function(arg,data)
if data.ID == "Error" and data.code_ == 400 then
...
Restrict(ChatID,UserID,1)
redis:hset(marco..'username:'..UserID, 'username', Resolv)
redis:sadd(marco..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end 
if cmd =="fktqeed" then
Restrict(ChatID,UserID,2)
redis:srem(marco..':tqeed:'..ChatID,UserID)
return SendMention(ChatID,UserID,MsgID,'-العضو ⇦ ❪ '..USERNAME..' ❫\n- الايدي ⇦ ❪ '..UserID..' ❫\n- تم فگ تقييد آلعضـو بنجآح \n✓️',17,USERCAR) 
end
if cmd == "setwhitelist" then
if redis:sismember(marco..'whitelist:'..ChatID,UserID) then 
...
if cmd == "dn_sudo" then
if not redis:sismember(marco..':SUDO_BOT:',UserID) then return sendMsg(ChatID,MsgID,'-**العضو ⇦ '..USERNAME..' \n-** الايدي ⇦ (`'..UserID..'`)\n-**انه بالتأكيد ليس مطور \n✓') end
redis:srem(marco..':SUDO_BOT:',UserID) 
return SendMention(ChatID,UserID,MsgID,'-العضو ⇦ ❪ '..USERNAME..' ❫\n-الايدي ⇦ ❪ '..UserID..' ❫\n-تم تنزيله من المطورين \n✓️',17,USERCAR) 
end
...
if redis:get(marco..'welcome:get'..msg.chat_id_) then welcomex = "❪ مفعل ❫" else welcomex = "❪ معطل ❫" end
if redis:get(marco..'lock_id'..msg.chat_id_) then lock_idx = "❪ مفعل ❫" else lock_idx = "❪ معطل ❫" end
if redis:get(marco..'replay'..msg.chat_id_)  then replayx  = "❪ مفعل ❫" else replayx  = "❪ معطل ❫" end
if redis:get(marco..'lock_woring'..msg.chat_id_) then lock_woringx = "❪ مفعل ❫" else lock_woringx  = "❪ معطل ❫" end
list_settings = "*-* اعدادات المجموعه : \n"
.."\n1-╿التعديل «⇦ "..(redis:get(marco..'lock_edit'..msg.chat_id_) or 'false')
.."\n2-│الروابط «⇦ "..(redis:get(marco..'lock_link'..msg.chat_id_) or 'false')
.."\n3-│التاك «⇦ "..(redis:get(marco..'lock_tag'..msg.chat_id_) or 'false')
.."\n4-│المعرفات «⇦ "..(redis:get(marco..'lock_username'..msg.chat_id_) or 'false')
.."\n5-│التكرار «⇦ "..(redis:get(marco..'lock_flood'..msg.chat_id_) or 'false')
.."\n6-│الكلايش «⇦ "..(redis:get(marco..'lock_spam'..msg.chat_id_) or 'false')
.."\n7-│الويب «⇦ "..(redis:get(marco..'lock_webpage'..msg.chat_id_) or 'false')
.."\n8-│الماركدوان «⇦ "..(redis:get(marco..'lock_markdown'..msg.chat_id_) or 'false')
.."\n9-│بالطرد البوتات «⇦ "..(redis:get(marco..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n10-│البوتات «⇦ "..(redis:get(marco..'lock_bots'..msg.chat_id_) or 'false')
.."\n11-│عدد التكرار «⇦ "..(redis:get(marco..'num_msg_marco'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n-│اعدادات الوسائط :\n"
.."\n*1-│*المتحركه «⇦ "..(redis:get(marco..'mute_gif'..msg.chat_id_) or 'false')
.."\n2-│الدردشه «⇦ "..(redis:get(marco..'mute_text'..msg.chat_id_) or 'false')
.."\n3-│الانلاين «⇦ "..(redis:get(marco..'mute_inline'..msg.chat_id_) or 'false')
.."\n4-│الالعاب «⇦"..(redis:get(marco..'mute_game'..msg.chat_id_) or 'false')
.."\n5-│الصور «⇦ "..(redis:get(marco..'mute_photo'..msg.chat_id_) or 'false')
.."\n6-│الفيديو «⇦ "..(redis:get(marco..'mute_video'..msg.chat_id_) or 'false')
.."\n7-│البصمات «⇦ "..(redis:get(marco..'mute_audio'..msg.chat_id_) or 'false')
.."\n8-│الصوت «⇦ "..(redis:get(marco..'mute_voice'..msg.chat_id_) or 'false')
.."\n9-│الملصقات «⇦ "..(redis:get(marco..'mute_sticker'..msg.chat_id_) or 'false')
.."\n10-│الجهات «⇦ "..(redis:get(marco..'mute_contact'..msg.chat_id_) or 'false')
.."\n11-│التوجيه «⇦ "..(redis:get(marco..'mute_forward'..msg.chat_id_) or 'false')
.."\n12-│الموقع «⇦ "..(redis:get(marco..'mute_location'..msg.chat_id_) or 'false')
.."\n13-│الملفات «⇦ "..(redis:get(marco..'mute_document'..msg.chat_id_) or 'false')
.."\n14-│الاشعارات «⇦ "..(redis:get(marco..'mute_tgservice'..msg.chat_id_) or 'false')
.."\n15-│الكيبورد «⇦ "..(redis:get(marco..'mute_keyboard'..msg.chat_id_) or 'false')
.."\n\nـــــــــــــــــــــــــــــــــــــــــــــــــــــــــ\n*-│*اعدادات اخرى : "
.."\n\n*1-│*الترحيب «⇦ "..welcomex
.."\n*2-│*الردود «⇦ "..replayx
...
list_settings = "-`اعدادات المجموعه :` "
.."\n\n-1╿التاك «⇦ "..(redis:get(marco..'lock_tag'..msg.chat_id_) or 'false')
.."\n-2|المعرفات «⇦ "..(redis:get(marco..'lock_username'..msg.chat_id_) or 'false')
.."\n-3|التعديل «⇦ "..(redis:get(marco..'lock_edit'..msg.chat_id_) or 'false')
.."\n-4|الروابط «⇦ "..(redis:get(marco..'lock_link'..msg.chat_id_) or 'false')
.."\n-5|التكرار «⇦ "..(redis:get(marco..'lock_flood'..msg.chat_id_) or 'false')
.."\n-6|الكلايش «⇦ "..(redis:get(marco..'lock_spam'..msg.chat_id_) or 'false')
.."\n-7|الويب «⇦ "..(redis:get(marco..'lock_webpage'..msg.chat_id_) or 'false')
.."\n-8|الماركدوان «⇦ "..(redis:get(marco..'lock_markdown'..msg.chat_id_) or 'false')
.."\n-9|البوتات بالطرد «⇦ "..(redis:get(marco..'lock_bots_by_kick'..msg.chat_id_) or 'false')
.."\n-10|البوتات «⇦ "..(redis:get(marco..'lock_bots'..msg.chat_id_) or 'false')
.."\n-11|عدد التكرار «⇦ "..(redis:get(marco..'num_msg_marco'..msg.chat_id_) or 'false')
.."\n—————————\n*-*اعدادات التقـييد :\n"
.."\n*-1|*التقييد بالتوجيه «⇦ "..(redis:get(marco..':tqeed_fwd:'..msg.chat_id_) or 'false')
.."\n*-2|*التقييد بالصور «⇦ "..(redis:get(marco..':tqeed_photo:'..msg.chat_id_) or 'false')
.."\n*-3|*التقييد بالروابط «⇦ "..(redis:get(marco..':tqeed_link:'..msg.chat_id_) or 'false')
.."\n*-4|*التقييد بالمتحركه «⇦ "..(redis:get(marco..':tqeed_gif:'..msg.chat_id_) or 'false')
.."\n*-5|*التقييد الفيديو «⇦ "..(redis:get(marco..':tqeed_video:'..msg.chat_id_) or 'false')
list_settings = list_settings:gsub('true', '❬ مقفول ❭')
list_settings = list_settings:gsub('false', '❬ مفتوح ❭')
